...
class ProgressInfo {
  ...
  static Widget spinner({required BuildContext context,String message = "Proszę czekać"}) {
  ...
  static Future<T?> showLoadingDialog<T>(
    ...
    showDialog(
      ...
      builder: (BuildContext context) => spinner(context: context, message: message ?? localizations.progressPleaseWait),
    );
