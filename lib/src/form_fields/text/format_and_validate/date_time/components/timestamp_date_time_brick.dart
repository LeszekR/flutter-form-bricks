...
abstract class DateTimeBrick implements Comparable<DateTimeBrick> {
  ...
  DateTimeBrick(this._dateTime);

  DateTime get dateTime => _dateTime;

  @override
  int compareTo(DateTimeBrick other) {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
          other is DateTimeBrick && runtimeType == other.runtimeType && dateTime == other.dateTime;
