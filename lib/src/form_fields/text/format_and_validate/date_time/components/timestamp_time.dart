...
class Time extends DateTimeBrick /*implements Comparable<Time>*/ {
  ...
  static Time fromString(String stringVal) {
    final parsed = _isSecondsPrecision(stringVal) //hotfix. Need to discuss the time handling in the project
        ? DateTimeBrick.timeFormatSecondsPrecision.parseStrict(stringVal)
        : DateTimeBrick.timeFormatMinutePrecision.parseStrict(stringVal);

    return Time(parsed);
  }

  factory Time.fromDateTime(DateTimeBrick dateTime) {
  ...
  String toJson() => DateTimeBrick.timeFormatMinutePrecision.format(dateTime);
...
//
// @override
// String toString() => DateTimeBrick.timeFormatMinutePrecision.format(_dateTime);
//
// @override
