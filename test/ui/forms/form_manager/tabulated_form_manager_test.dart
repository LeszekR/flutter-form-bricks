...
//     await tester.pump();
//     expect(find.text_formatter_validators("1234"), findsExactly(allKeys.length));
//
...
//     }
//     await tester.pump();
//     expect(find.text_formatter_validators("input with trailing space "), findsExactly(allKeys.length));
//
//     //when
//     final FormStatus result = formManager.checkStatus();
//
