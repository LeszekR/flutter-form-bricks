...
void main() {
  ...
  testWidgets("Should test trimming spaces in only lowercase text field", (WidgetTester tester) async {
    ...
    const String lowercaseKey = "2 lowercase text";
    ...
    // Then
    final resultOne =
        (find.byKey(const Key(lowercaseKey)).evaluate().first.widget as FormBuilderTextField).controller!.text;
  ...
  testWidgets("Should test trimming spaces in multiline text field", (WidgetTester tester) async {
    ...
    // Then
    final resultOne =
        (find.byKey(const Key(multilineTextKey)).evaluate().first.widget as FormBuilderTextField).controller!.text;
  ...
  testWidgets("Should test trimming spaces in regular input single", (WidgetTester tester) async {
    ...
    // Then
    final resultOne =
        (find.byKey(const Key(regularInputKeyString)).evaluate().first.widget as FormBuilderTextField).controller!.text;
  ...
  testWidgets('should stay in focus when clicked Enter for regular input single', (WidgetTester tester) async {
    ...
    for (var method in inputs.entries) {
      ...
      await tester.enterText(find.byKey(const Key(regularInputKeyString)), "text example");
      await tester.pump();
