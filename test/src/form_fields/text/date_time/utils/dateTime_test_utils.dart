...
class TestDateFormatter implements ATestDateTimeFormatter {
  ...
  @override
  DateFieldContent makeDateTime(BricksLocalizations localizations, String inputString, DateTimeLimits dateLimits) {
    return dateFormatter.run(localizations, inputString, dateLimits);
  }
}
