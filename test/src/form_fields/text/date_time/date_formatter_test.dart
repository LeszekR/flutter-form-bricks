...
void main() {
  ...
  testWidgets('date too early or too late', (WidgetTester tester) async {
    ...
    final String yearMaxBack = dateTimeLimits.minDateTime!.year.toString().toString();
    final String yearMaxForward = dateTimeLimits.maxDateTime!.year.toString().toString();
    ...
    var testCases = [
      DateTimeTestCase("0000,12,9", "0000-12-09", false, local.dateErrorTooFarBack(yearMaxBack)),
  ...
  testWidgets('multiple errors', (WidgetTester tester) async {
    ...
    var testCases = [
      ...
      DateTimeTestCase("01-0-00", "2001-00-00", false,
          local.dateErrorTooFarBack(yearMaxBack) + '\n' + local.dateErrorMonth0 + '\n' + local.dateErrorDay0),
      DateTimeTestCase(
          "01-0-31", "2001-00-31", false, local.dateErrorTooFarBack(yearMaxBack) + '\n' + local.dateErrorMonth0),
      DateTimeTestCase(
          "268855", "2026-88-55", false, local.dateErrorMonthOver12 + '\n' + local.dateErrorTooManyDaysInMonth),
      DateTimeTestCase("0000 0 0", "0000-00-00", false,
          local.dateErrorTooFarBack(yearMaxBack) + '\n' + local.dateErrorMonth0 + '\n' + local.dateErrorDay0),
      DateTimeTestCase(
          "558855",
          "2055-88-55",
