...
import 'package:flutter_form_bricks/src/form_fields/text/lowercase/lowercase_formatter.dart';
...
void main() {
  const String keyString = "2 lowercase text_formatter_validators";
  ...
  testWidgets("Should test trimming spaces in lowercase text_formatter_validators field", (WidgetTester tester) async {
    const String keyString = "2 lowercase text_formatter_validators";
  ...
  testWidgets('should stay in focus when clicked Enter in lowercase text_formatter_validators field', (WidgetTester tester) async {
    BuildContext context = await pumpAppGetContext(tester);
    //given
